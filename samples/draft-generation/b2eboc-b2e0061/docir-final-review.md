...
- Approved Draft bytes hash：`sha256:c45a6bbbf8cda12e0632d9b3b89f13e63645bf9ae1ea4ff9608b633be3573aa6`
- Approved Draft size：`12045` bytes
...
2. DocIR 使用通用九列 Fields contract；原两列校验内容按原顺序无损合并为 `校验点`，`obssid` 按“通常可空、交易类型为 2 时非空”确认为 `C`。
