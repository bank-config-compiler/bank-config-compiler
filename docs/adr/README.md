...
- `ADR-0008-directional-template-bindings-and-bank-conditions.md`：规定 raw-doc/SchemaIR 的银行事实优先级、Template Standard 镜像、容器 coverage、PARSE collection binding、方向级 encoding，并将银行文档明确条件归入 Standard 约束。
